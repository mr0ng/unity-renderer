...
namespace DCL
{
    public class DebugConfigComponentVR : MonoBehaviour
    {
        private static DebugConfigComponentVR sharedInstance;
        ...
        public static DebugConfigComponentVR i
        {
            get
            {
                if (sharedInstance == null)
                    sharedInstance = FindObjectOfType<DebugConfigComponentVR>();
